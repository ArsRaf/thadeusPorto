...
export const projects = [
  // ── Shorts ───────────────────────────────────────────────
  {
    ...
    media: [
      ...
      { type: 'image', src: '/assets/ed-char-illus.jpg', label: 'Character Illustration', shape: 'port', fit: 'contain' , note: 'Two opposite ideas mashed into one silhouette: a shojo magic girl and a Japanese 80s delinquent.' },
      ...
      { type: 'image', src: '/assets/ed-ost-ref.jpg', label: 'Score — Reference', shape: 'wide' , note: 'The track the cut was timed against.' },

      { chapter: 'Wakaba', note: 'The hero character - T-pose, topology, and the shakujo staff — built from scratch.' },
      { type: 'video', src: '/assets/ed-turntable.mp4', poster: '/assets/posters/ed-turntable.jpg', label: 'Turntable', shape: 'port', note: 'The finished model rotating - silhouette checked from every angle.' },
      { type: 'image', src: '/assets/ed-turn-clay.jpg', label: 'Turnaround — Clay', shape: 'tall' , note: 'The same pose untextured — silhouette and topology checked before any colour.' },
      ...
      { type: 'image', src: '/assets/ed-staff-detail.jpg', label: 'Staff — Ofuda Detail', shape: 'half' , note: 'Ofuda talismans modelled as separate geometry so they swing on their own.' },
      ...
      { type: 'video', src: '/assets/ed-skincheck.mp4', poster: '/assets/posters/ed-skincheck.jpg', label: 'Skin Check', shape: 'half', note: 'Deformation checked across the mesh before rigging proper.' },
      ...
      { chapter: 'Ponta', note: 'The monster of the second act - modelled, rigged and posed as a character in his own right.' },
      { type: 'video', src: '/assets/ponta-render.mp4', poster: '/assets/posters/ponta-render.jpg', label: 'Ponta - Final Render', shape: 'hero', note: 'The finished creature in motion.' },
      { type: 'video', src: '/assets/ponta-tpose.mp4', poster: '/assets/posters/ponta-tpose.jpg', label: 'Ponta - T-Pose Turnaround', shape: 'port', note: 'Base mesh checked from every angle before rigging.' },
      { type: 'video', src: '/assets/ponta-rig.mp4', poster: '/assets/posters/ponta-rig.jpg', label: 'Ponta - Rig Turnaround', shape: 'port', note: 'The control rig driven through its range.' },
      { type: 'video', src: '/assets/ponta-pose.mp4', poster: '/assets/posters/ponta-pose.jpg', label: 'Ponta - Pose Turnaround', shape: 'half', note: 'Posed to test how the rig holds up under deformation.' },
      { type: 'image', src: '/assets/ponta-stats.jpg', label: 'Ponta - Mesh Stats', shape: 'half', fit: 'contain', note: 'Built deliberately light so he could carry a full fight sequence.' },

      { chapter: 'Rigging & Shading', note: 'A custom Fresnel toon shader driving 985 materials.' },
      { type: 'image', src: '/assets/ed-shader-nodes.jpg', label: 'Toon Shader — Node Graph', shape: 'hero', fit: 'contain' , note: 'The custom Fresnel toon shader. A ColorRamp on a Fresnel node drives the terminator, which meant lighting the whole film with one key and a single-colour HDRI.' },
      { type: 'image', src: '/assets/ed-rig.jpg', label: 'Rig — Assets', shape: 'half' , note: 'Rig assets laid out for animation.' },
      { type: 'video', src: '/assets/ed-rig-demo.mp4', poster: '/assets/posters/ed-rig-demo.jpg', label: 'Rig - Range of Motion', shape: 'half', note: 'The control rig driven through its full range.' },
      { type: 'video', src: '/assets/ed-rig-stress.mp4', poster: '/assets/posters/ed-rig-stress.jpg', label: 'Rig - Stress Test', shape: 'half', note: 'Pushed past normal poses to find where the deformation breaks.' },
      ...
      { type: 'image', src: '/assets/wakaba-stats.jpg', label: 'Production Stats', shape: 'half', fit: 'contain' , note: 'Final production tally.' },
    ],
  },
  {
    id: 'hotsauce-ad',
  ...
  // ── Modelling ────────────────────────────────────────────
  {
    ...
    category: 'Modelling',
    year: '2024',
    description: 'A stylised-realistic character study - close-up face work pushing skin shading, eye detail and groomed hair toward photo-real.',
    ...
    media: [
      ...
      { type: 'image', src: '/assets/realistic-a.png', label: 'Face Study 01' },
      { type: 'image', src: '/assets/realistic-b.png', label: 'Face Study 02' },
      { type: 'image', src: '/assets/realistic-c.png', label: 'Face Study 03' },
      { type: 'image', src: '/assets/realistic-d.png', label: 'Face Study 04' },
    ],
  },
